package org.bachelor.common.auth.controller;

import io.swagger.annotations.ApiImplicitParam;
import io.swagger.annotations.ApiImplicitParams;
import io.swagger.annotations.ApiOperation;
import org.bachelor.common.auth.service.AuthorizeService;
import org.bachelor.common.auth.vo.Permission;
...
public class AuthorizeController {
    ...
    public ResponseEntity setRolePermission(@PathVariable("role") String role, @RequestBody List<Permission> perms) {
    ...
    public ResponseEntity setOrgPermission(@PathVariable("org") String org, @RequestBody List<Permission> perms) {
