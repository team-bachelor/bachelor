...
public class UserManageDaoImpl extends GenericDaoImpl<User, String> implements
		IUserManageDao {
	...
	public List<User> findByExample(User user) {
		...
		/**添加分页条件**/
		List<User> user_list = getJdbcTemplate().query(pageSql(qSQL.toString()), new RowMapper(){
