...
export default {
    ...
    delOrg: {url: '/contact/organization/delete/:id', method: 'delete'},
    getOrg: {url: '/contact/organization/get/:id', method: 'get'},
    addOrg: {url: '/contact/organization/add', method: 'post'},
    updateOrg: {url: '/contact/organization/update', method: 'put'},

    orgTree: {url: '/contact/organization/findOrganizationTree', method: 'get'},

    //批量导入
    importBookExcel: {url: '/contact/import/importBookExcel', method: 'post'},
};
