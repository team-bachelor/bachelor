...
-- ----------------------------
INSERT INTO `cmn_acm_menu` VALUES ('1', '服务管理', 'menu.service', '/service', 'el-icon-mobile-phone', 'i', '', '服务管理', 0, '2018-12-11 11:41:44', '');
INSERT INTO `cmn_acm_menu` VALUES ('19', '角色管理', 'menu.roles', '/roles', 'fa fa-user-circle-o', 'i', '', '角色管理', 0, '2018-12-11 11:46:14', '');
INSERT INTO `cmn_acm_menu` VALUES ('2', '配置中心', 'menu.config', '/config', 'el-icon-date', 'i', '', '配置中心', 0, '2018-12-11 11:46:14', '');
INSERT INTO `cmn_acm_menu` VALUES ('3', '统一网关', 'menu.gateway', '/gateway', 'el-icon-date', 'i', '', '统一网关', 0, '2018-12-11 11:46:14', '');
INSERT INTO `cmn_acm_menu` VALUES ('4', '监控中心', 'menu.monitor', '', 'el-icon-date', 'i', '', '监控中心', 0, '2018-12-11 11:46:14', '');
INSERT INTO `cmn_acm_menu` VALUES ('5', '服务跟踪', 'menu.monitor.trace', '/monitor/service', 'el-icon-date', 'i', '4', '服务跟踪', 0, '2018-12-11 11:46:14', '');
INSERT INTO `cmn_acm_menu` VALUES ('6', '日志跟踪', 'menu.monitor.log', '/monitor/log', 'el-icon-date', 'i', '4', '日志跟踪', 0, '2018-12-11 11:46:14', '');
INSERT INTO `cmn_acm_menu` VALUES ('7', '基础监控', 'menu.monitor.infra', '/monitor/base', 'el-icon-date', 'i', '4', '基础监控', 0, '2018-12-11 11:46:14', '');
INSERT INTO `cmn_acm_menu` VALUES ('8', '容错情况', 'menu.monitor.brk', '/monitor/turbine', 'el-icon-date', 'i', '4', '容错情况', 0, '2018-12-11 11:46:14', '');
...
-- ----------------------------
INSERT INTO `cmn_acm_obj_domain` VALUES ('1', '服务管理', 'service', 1, '2018-10-29 09:51:24', 'system');
INSERT INTO `cmn_acm_obj_domain` VALUES ('2', '配置中心', 'config', 2, '2018-10-29 10:18:53', 'system');
INSERT INTO `cmn_acm_obj_domain` VALUES ('3', '统一网关', 'gateway', 3, '2019-01-26 16:22:30', 'system');
INSERT INTO `cmn_acm_obj_domain` VALUES ('4', '监控中心', 'monitor', 4, '2019-01-26 16:22:30', 'system');
...
INSERT INTO `cmn_acm_obj_operation` VALUES ('5', '获取注册服务', 'geteu', 'GET', b'0', '2019-03-05 14:22:18', 'system');
...
INSERT INTO `cmn_acm_role` VALUES ('2', '普通用户', 'normal_user', 'sys', '2018-10-22 15:41:29', 'system');
INSERT INTO `cmn_acm_role` VALUES ('21ebe8f1-ed41-48a1-b535-324319047846', 'xxxxffvccccc2', 'bfds4', '003', '2019-03-05 21:41:05', 'system');
INSERT INTO `cmn_acm_role` VALUES ('2a64f14c-5001-496c-8166-9684cae059a2', '修改配置', 'modify', 'gwh', '2019-03-27 09:15:22', 'system');
INSERT INTO `cmn_acm_role` VALUES ('8cdd5ed2-7662-46c5-bf98-caa642e400ce', '丝丝11', '2222', 'test0305', '2019-03-10 20:21:15', 'system');
INSERT INTO `cmn_acm_role` VALUES ('8fbdddd2-9829-4626-91eb-f68c81195331', '统一网关', 'testRole', 'gwh', '2019-03-13 13:27:00', 'system');
...
-- ----------------------------
INSERT INTO `cmn_acm_role_menu` VALUES ('01de1af8-a82f-41fd-a461-29003a393d2b', 'sys_admin', 'menu.monitor', '2019-03-05 17:37:22', 'liuxiujun');
INSERT INTO `cmn_acm_role_menu` VALUES ('32be3bff-ba20-40db-b14a-d9251554b93f', 'sys_admin', 'menu.roles', '2019-03-05 17:37:22', 'liuxiujun');
INSERT INTO `cmn_acm_role_menu` VALUES ('348008cb-af3e-4f67-b4ea-ed9669a1c2bb', 'sys_admin', 'menu.monitor', '2019-03-05 17:37:22', 'liuxiujun');
INSERT INTO `cmn_acm_role_menu` VALUES ('3a931500-df39-47b8-8ff9-1f6bb0f1d2b7', 'sys_admin', 'menu.service', '2019-03-05 17:37:22', 'liuxiujun');
INSERT INTO `cmn_acm_role_menu` VALUES ('5f39ec5f-77b4-4b6f-a089-6af9984a6359', 'sys_admin', 'menu.monitor.log', '2019-03-05 17:37:22', 'liuxiujun');
INSERT INTO `cmn_acm_role_menu` VALUES ('68611a0d-be43-4863-8c0b-191cdf599807', 'sys_admin', 'menu.monitor.infra', '2019-03-05 17:37:22', 'liuxiujun');
INSERT INTO `cmn_acm_role_menu` VALUES ('6d5920e2-af87-403c-8e4c-73a8dd930249', 'sys_admin', 'menu.monitor', '2019-03-05 17:37:22', 'liuxiujun');
INSERT INTO `cmn_acm_role_menu` VALUES ('82a18a77-17ca-4f1a-b204-d6fb7232abdd', 'sys_admin', 'menu.monitor.brk', '2019-03-05 17:37:22', 'liuxiujun');
INSERT INTO `cmn_acm_role_menu` VALUES ('9a0ed0f4-716a-4a78-87b2-e7d249be43ec', 'sys_admin', 'menu.monitor', '2019-03-05 17:37:22', 'liuxiujun');
INSERT INTO `cmn_acm_role_menu` VALUES ('aec20261-39a9-453a-b4ca-d1c89926e532', 'modify', 'menu.config', '2019-03-27 09:15:30', 'liujintao');
INSERT INTO `cmn_acm_role_menu` VALUES ('b3e98d19-43fa-4e78-9e58-c0d5f732152d', '2222', 'menu.config', '2019-03-10 20:24:04', 'liuxiujun');
INSERT INTO `cmn_acm_role_menu` VALUES ('be1ee11f-43ee-47b0-ad51-e02ac4266a31', 'sys_admin', 'menu.gateway', '2019-03-05 17:37:22', 'liuxiujun');
INSERT INTO `cmn_acm_role_menu` VALUES ('c44b9002-b380-493c-b462-01b126b548d6', 'testRole', 'menu.gateway', '2019-03-13 13:27:24', 'yusujuan');
INSERT INTO `cmn_acm_role_menu` VALUES ('dfb8fd06-9051-4daa-8906-3b9814c8b7df', 'sys_admin', 'menu.config', '2019-03-05 17:37:22', 'liuxiujun');
INSERT INTO `cmn_acm_role_menu` VALUES ('e03bb33c-e634-430d-a6b2-5c2b6061a258', 'sys_admin', 'menu.monitor.trace', '2019-03-05 17:37:22', 'liuxiujun');
INSERT INTO `cmn_acm_role_menu` VALUES ('e6f03e8e-e832-4bf6-aee5-b9994827f84f', 'sys_admin', 'menu.monitor', '2019-03-05 17:37:22', 'liuxiujun');
...
-- ----------------------------
INSERT INTO `cmn_acm_role_permission` VALUES ('100', 'leader_fg', 'post:/baseTicketInform', '/baseTicketInform', 'create', '2019-01-18 11:23:07', 'system');
INSERT INTO `cmn_acm_role_permission` VALUES ('101', 'leader_fg', 'delete:/baseTicketInform', '/baseTicketInform', 'delete', '2019-01-18 11:23:11', 'system');
INSERT INTO `cmn_acm_role_permission` VALUES ('102', 'leader_fg', 'put:/baseTicketInform', '/baseTicketInform', 'update', '2019-01-18 11:23:14', 'system');
INSERT INTO `cmn_acm_role_permission` VALUES ('103', 'leader_fg', 'get:/baseTicketInform', '/baseTicketInform', 'query', '2019-01-18 11:23:17', 'system');
INSERT INTO `cmn_acm_role_permission` VALUES ('104', 'leader_fg', 'get:/baseTicketInform/{serialNum}', '/baseTicketInform/{serialNum}', 'query', '2019-01-18 11:23:20', 'system');
INSERT INTO `cmn_acm_role_permission` VALUES ('105', 'post_cwc', 'post:/baseTicketInform', '/baseTicketInform', 'create', '2019-01-18 11:23:07', 'system');
INSERT INTO `cmn_acm_role_permission` VALUES ('106', 'post_cwc', 'delete:/baseTicketInform', '/baseTicketInform', 'delete', '2019-01-18 11:23:11', 'system');
INSERT INTO `cmn_acm_role_permission` VALUES ('107', 'post_cwc', 'put:/baseTicketInform', '/baseTicketInform', 'update', '2019-01-18 11:23:14', 'system');
INSERT INTO `cmn_acm_role_permission` VALUES ('108', 'post_cwc', 'get:/baseTicketInform', '/baseTicketInform', 'query', '2019-01-18 11:23:17', 'system');
INSERT INTO `cmn_acm_role_permission` VALUES ('109', 'post_cwc', 'get:/baseTicketInform/{serialNum}', '/baseTicketInform/{serialNum}', 'query', '2019-01-18 11:23:20', 'system');
INSERT INTO `cmn_acm_role_permission` VALUES ('110', 'post_jdzx', 'get:/baseTicketPrint', '/baseTicketPrint', 'query', '2019-01-18 11:23:20', 'system');
INSERT INTO `cmn_acm_role_permission` VALUES ('111', 'post_jdzx', 'put:/baseTicketPrint', '/baseTicketPrint', 'create', '2019-01-18 11:23:20', 'system');
INSERT INTO `cmn_acm_role_permission` VALUES ('112', 'post_jdzx', 'get:/baseTicketPrint/{baseTicketInformSerialNum}', '/baseTicketPrint/{baseTicketInformSerialNum}', 'query', '2019-01-18 11:23:20', 'system');
INSERT INTO `cmn_acm_role_permission` VALUES ('113', 'post_jdzx', 'get:/baseTicketIssue', '/baseTicketIssue', 'query', '2019-01-18 11:23:20', 'system');
INSERT INTO `cmn_acm_role_permission` VALUES ('114', 'post_jdzx', 'put:/baseTicketIssue', '/baseTicketIssue', 'update', '2019-01-18 11:23:20', 'system');
INSERT INTO `cmn_acm_role_permission` VALUES ('115', 'post_jdzx', 'get:/baseTicketIssue/{baseTicketInformSerialNum}', '/baseTicketIssue/{baseTicketInformSerialNum}', 'query', '2019-01-18 11:23:20', 'system');
INSERT INTO `cmn_acm_role_permission` VALUES ('116', 'post_zjjs', 'get:/baseTicketPrint', '/baseTicketPrint', 'query', '2019-01-18 11:23:20', 'system');
INSERT INTO `cmn_acm_role_permission` VALUES ('117', 'post_zjjs', 'put:/baseTicketPrint', '/baseTicketPrint', 'create', '2019-01-18 11:23:20', 'system');
INSERT INTO `cmn_acm_role_permission` VALUES ('118', 'post_zjjs', 'get:/baseTicketPrint/{baseTicketInformSerialNum}', '/baseTicketPrint/{baseTicketInformSerialNum}', 'query', '2019-01-18 11:23:20', 'system');
INSERT INTO `cmn_acm_role_permission` VALUES ('119', 'post_zjjs', 'get:/baseTicketIssue', '/baseTicketIssue', 'query', '2019-01-18 11:23:20', 'system');
INSERT INTO `cmn_acm_role_permission` VALUES ('120', 'post_zjjs', 'put:/baseTicketIssue', '/baseTicketIssue', 'update', '2019-01-18 11:23:20', 'system');
INSERT INTO `cmn_acm_role_permission` VALUES ('121', 'post_zjjs', 'get:/baseTicketIssue/{baseTicketInformSerialNum}', '/baseTicketIssue/{baseTicketInformSerialNum}', 'query', '2019-01-18 11:23:20', 'system');
INSERT INTO `cmn_acm_role_permission` VALUES ('122', 'post_cwc', 'get:/baseTicketIssue', '/baseTicketIssue', 'query', '2019-01-18 11:23:20', 'system');
INSERT INTO `cmn_acm_role_permission` VALUES ('123', 'post_cwc', 'put:/baseTicketIssue', '/baseTicketIssue', 'update', '2019-01-18 11:23:20', 'system');
INSERT INTO `cmn_acm_role_permission` VALUES ('124', 'post_cwc', 'get:/baseTicketIssue/{baseTicketInformSerialNum}', '/baseTicketIssue/{baseTicketInformSerialNum}', 'query', '2019-01-18 11:23:20', 'system');
INSERT INTO `cmn_acm_role_permission` VALUES ('125', 'committee', 'get:/baseTicketIssue', '/baseTicketIssue', 'query', '2019-01-18 11:23:20', 'system');
INSERT INTO `cmn_acm_role_permission` VALUES ('126', 'committee', 'put:/baseTicketIssue', '/baseTicketIssue', 'update', '2019-01-18 11:23:20', 'system');
INSERT INTO `cmn_acm_role_permission` VALUES ('127', 'committee', 'get:/baseTicketIssue/{baseTicketInformSerialNum}', '/baseTicketIssue/{baseTicketInformSerialNum}', 'query', '2019-01-18 11:23:20', 'system');
INSERT INTO `cmn_acm_role_permission` VALUES ('128', 'post_zjjs', 'get:/baseTicketInform/{serialNum}', '/baseTicketInform/{serialNum}', 'query', '2019-01-18 11:23:20', 'system');
INSERT INTO `cmn_acm_role_permission` VALUES ('129', 'post_jdzx', 'get:/baseTicketInform/{serialNum}', '/baseTicketInform/{serialNum}', 'query', '2019-01-18 11:23:20', 'system');
