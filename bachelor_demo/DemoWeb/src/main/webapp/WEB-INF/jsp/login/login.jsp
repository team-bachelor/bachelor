  ...
  <body>
    ...
    <div class="container">
      ...
      <hr>
        ...
        <input name="userId" type="text" class="input-block-level" placeholder="用户名">
        <input name="pwd" type="password" class="input-block-level" placeholder="密码">
        <button class="btn btn-large btn-primary" type="submit">登录</button>
        <button class="btn btn-large btn-primary" onclick="javascript:testJsonEx();" type="button">测试Json异常</button>
      </form>
