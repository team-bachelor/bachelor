...
<html lang="en">
  <head>
   ...
   <body>
	...
	<form class="form-inline" name="report" action="doVerify.htm" method="post">
		<div>
			<input type="hidden" value="${model.domain.id }" name="id">
			<input type="hidden" value="${model.taskId }" name="taskId">
			<span class="label">标题:</span>
			<input type="text" class="span2" name="title" readonly="readonly" value="${model.domain.title }">
		</div>
		<div>
			<span class="label">内容:</span>
			<input type="text" class="span3" name="content" readonly="readonly" value="${model.domain.content }">
		</div>
		<div>
			<span class="label">审核意见:</span>
			<input type="text" class="span3" name="verify" >
		</div>
		<div>
			<span class="label">备注</span>
			<input type="text" class="span3" name="comment" >
		</div>		
