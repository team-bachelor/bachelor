...
public class ClientConstant {
    public static final String UPUSERID = "_up_user_id";
    public static final String UPOPENID = "_up_open_id";
    public static final String UPUSER = "_up_user";
    public static final String ACCESS = "_access_token";
    public static final String UPORGID		="_up_org_id";
    public static final String UPUSERNAME	="_up_user_name";
    public static final String UPORGNAME	="_up_org_name";
    public static final String UPDEPTID		="_up_dept_id";
    public static final String UPDEPTNAME	="_up_dept_name";
    public static final String SESSIONAUTHENTICATIONKEY="up_authenticate_key";
