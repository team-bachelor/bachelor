...
//        return true;
        ...
        if (!pass) {
            ...
            try {
                if (!iamConfiguration.isJsonResponse()) {
                    response.sendRedirect(iamConfiguration.getLoginURL());
                    return false;
                }
    ...
    private PermissionOptions.AccessType getAccessType(Object handler) {
        if (handler instanceof HandlerMethod) {
            return PermissionOptions.AccessType.INTERFACE;
        } else if (handler instanceof ResourceHttpRequestHandler) {
            return PermissionOptions.AccessType.RESOURCE;
        }
        return null;
    }
